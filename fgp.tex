...
\begin{exemplo}{}{}
    Voltando ao exemplo da cadeia de ramificação $(Z_n)$ com $p = (\frac{1}{2}, \frac{1}{4}, \frac{1}{8}, \dots)$, qual a probabilidade de extinção da cadeia?
\end{exemplo}

\begin{sol}
    Queremos encontrar o ponto fíxo $p_e = \Pi_X(p_e)$. Observe que:

    \[
    \Pi_X(s) = \sum_{x=0}^{\infty}\Pp(X=x)s^x = \sum_{x=0}^{\infty} \frac{s^x}{2^{i+1}} = \frac{1}{2} + \frac{s}{4} + \frac{s^2}{8} + \dots
    \]

    Que é uma P.G infinita com razão $s/2$, como $p_e \leq 1$, temos que

    \[
    \Pi_X(p_e) = \frac{1}{2-p_e}
    \]

    Resolvendo $\Pi_X(p_e) = p_e$, obtemos $(p_e - 1)^2 = 0$, e portanto $p_e = 1$.
\end{sol}

\begin{exemplo}{}{}
    Voltando ao exemplo da cadeia de ramificação $(Z_n)$ com  $p_0 = \frac{1}{4}$, $p_1 = \frac{1}{2}$, $p_2 = \frac{1}{4}$ e $p_i = 0 \quad \forall i\geq 3$, qual a probabilidade de extinção da cadeia? 
\end{exemplo}

\begin{sol}
    Novamente, buscamos encontrar o ponto fixo $p_e = \Pi_X(p_e)$. Temos:

    \[
    \Pi_X(s)=\sum_{x=0}^\infty \Pp(X=x)s^x 
    = \tfrac{1}{4} + \tfrac{1}{2}s + \tfrac{1}{4}s^2.
    \]

    Fazendo $ \Pi_X(p_e) = p_e$, obtemos, novamente, $(p_e-1)^2 = 0$, e portanto, $p_e = 1$.
...
\begin{exemplo}{}{}
    Considere uma cadeia de ramificação $(Z_n)$ com  $p_0 = \frac{1}{4}$, $p_1 = \frac{1}{4}$, $p_2 = \frac{1}{2}$ e $p_i = 0 \quad \forall i\geq 3$, qual a probabilidade de extinção da cadeia? 
\end{exemplo}

\begin{sol}
    Observe que $\mu = \E[X] = \frac{1}{4} + \frac{1}{2} = \frac{5}{4} > 1$. Portanto, já sabemos que a probabibilidade de extinção não é $1$. Podemos calcula-la buscando o ponto fixo $p_e = \Pi_X(p_e)$. Temos:

    \[
    \Pi_X(s)=\sum_{x=0}^\infty \Pp(X=x)s^x 
    = \tfrac{1}{4} + \tfrac{1}{4}s + \tfrac{1}{2}s^2.
    \]

    Fazendo $ \Pi_X(p_e) = p_e$, obtemos, a equação quadrática $2p_e^2 - 3p_e + 1 = 0$, cuja a única raíz não-negativa menor que $1$ é $p_e = \frac{1}{2}$.
