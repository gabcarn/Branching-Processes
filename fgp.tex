...
\usepackage[portuguese]{babel} % Para hifenização em português

\usepackage{amsmath}    % Para equações
\usepackage{amssymb}    % Para \mathbb
\usepackage{amsthm}     % Para ambientes de teorema/definição
% --- Pacotes para o gráfico ---
\usepackage{tikz}
\usepackage{pgfplots}
\pgfplotsset{compat=1.17} % Usa uma versão moderna do pgfplots
% -----------------------------
...
% Comando customizado para a Esperança
\DeclareMathOperator*{\E}{\mathbb{E}}

% OBS: Não estava conseguindo usar o latex no vsCode, por isso não usei o packages.tex
